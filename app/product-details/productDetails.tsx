...
const mockProducts = [
  { id: 1, name: 'Soft Chairs', price: 49.99, originalPrice: 69.99, image: softChairsImage, ranges: [{ cashback: 10 }] },
  { id: 2, name: 'Sofa Chair', price: 89.99, image: sofaChairImage, ranges: [{ cashback: 5 }] },
  { id: 3, name: 'Kitchen Dishes', price: 39.99, originalPrice: 49.99, image: kitchenDishesImage, ranges: [] },
  { id: 4, name: 'Smart Watch', price: 99.99, image: smartWatchesImage, ranges: [{ cashback: 15 }] },
  { id: 5, name: 'Kitchen Mixer', price: 59.99, image: kitchenMixerImage, ranges: [] },
  { id: 6, name: 'Blenders', price: 34.99, originalPrice: 44.99, image: blendersImage, ranges: [{ cashback: 5 }] },
  { id: 7, name: 'Home Appliance', price: 79.99, image: homeApplianceImage, ranges: [] },
    ...
    <Box sx={{ p: 2, px: { xs: 2, md: 15 } }}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={10}>
          ...
          <Pagination count={5} page={page} onChange={handlePageChange} size="small" sx={{ display: 'flex', justifyContent: 'center', mt: 3 }} />
        </Grid>
      </Grid>
